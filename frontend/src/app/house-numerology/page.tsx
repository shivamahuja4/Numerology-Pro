    ...
    return (
        <DashboardLayout>
            <div className="max-w-4xl mx-auto space-y-8">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">House Numerology</h1>
                    <p className="text-gray-500">Check if your house number is lucky for you.</p>
                </div>
                            ...
                            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm space-y-6">
                                <div className="text-center pb-6 border-b border-gray-100">
                                    ...
                                    <div className="text-5xl font-bold text-gray-900">
                                        {result.house_total} <span className="text-3xl text-gray-400 font-normal">({result.house_compound})</span>
                                    </div>
                                    <p className="text-sm text-gray-500 mt-1">House Number Total</p>
                                </div>
