...
import { Car, CheckCircle, XCircle, AlertCircle, ArrowRight } from 'lucide-react';
    ...
    const handleAnalyze = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/analyze/vehicle', {
                ...
                body: JSON.stringify({ vehicle_number: vehicleNumber, dob }),
            });
        ...
        <DashboardLayout>
            <div className="max-w-3xl mx-auto space-y-8">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Check if your vehicle registration number is lucky for your birth date.</p>
                </div>
                    ...
                    <div className="space-y-6">
                        <div className={`p-6 rounded-xl border-l-4 shadow-sm flex items-start gap-4 ${getCompatibilityColor(result.compatibility)}`}>
                            ...
                            <div>
                                <h3 className="text-lg font-semibold mb-1">
                                    Your Vehicle Number is {result.compatibility}
                                </h3>
                                <p className="text-sm opacity-90">
                                    Vehicle Total: <span className="font-bold">{result.vehicle_total}</span> •
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                            ...
                            <p className="text-sm text-gray-500 mt-4">
                                Consider choosing a vehicle number that reduces to one of these digits (sum of digits).
                            </p>
                        </div>
                    </div>
                )}
